...
- :white_check_mark: **/ADC/**: Attitude Control Subsystem (Note: ADC is used in the folder name for brevity) --> Completed
...
3.  **What was the most challenging section, and why?**
...
4.  **If you employed Generative AI tools, how did you do so?**
...
5.  **What other resources did you use to find solutions?**
